...
\resumeHeadingListStart{}
  ...
  \resumeItemListStart{}
    \resumeItem{Rewrite of our in-house event ingestion service in Flink + Kafka to add features, modernize, and scale to bursts of high traffic. I advocated for the project, designed the system, and implemented much of the business logic.}
    \resumeItemListStart{}
    ...
    \resumeItemListEnd{}
    \resumeItem{Deployed Amundsen, an OSS data-discovery platform, with a custom AWS Neptune backend.}
    \resumeItem{Jupyter infrastructure based on Docker, Papermill, and NBViewer.}

  \resumeItemListEnd{}
  We also owned the core data stack: \href{https://github.com/seatgeek/druzhba}{\uline{Druzhba}} (built-in-house ETL), DBT, Looker, Luigi, Redshift, and other AWS products.

  \resumeQuadHeadingChild{Sr. Data Scientist}{2019-2020}
  \resumeQuadHeadingChild{Data Scientist II}{2018}

  I specialized in user recommendation signals and our event catalog, working in Spark, SQL, and Python. Projects included:
  \resumeItemListStart{}
  \resumeItem{Algorithms for the weekly newsletter, cart abandonment and price drops notifications, in Spark + SQL. This tripled the direct revenue of the weekly newsletter immediately.}
  ...
  \resumeItem{Ongoing involvement in the design and measurement of recommendation, search, and CRM marketing.}
  \resumeItemListEnd{}
  
  \resumeQuadHeadingChild{Software Engineer, Discovery}{Sept 2016-2017}

  I built features for search, CRM marketing, and frontpage recommendations.

  \resumeSingleHeading{Other}
  \resumeQuadHeadingChild{Greater Harlem Coalition (Volunteer)}{2022-}
  Contributed data analysis, writing, editing, and website administration for a community advocacy group. My data pipeline uses DBT, Dagster, and PostGIS (code \href{https://github.com/skritch/ghc-analysis}{\uline{here}}.)
