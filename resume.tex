...
\resumeHeadingListStart{}
  ...
  \resumeItemListStart{}
    \resumeItem{Rewrite of our in-house event ingestion service in Flink + Kafka. Our primary goal was scalability—the earlier  RabbitMQ-based system was very unstable—but we also added a number of features:}
    \resumeItemListStart{}
    \resumeItem{Fanout to multiple downstreams: front page recommendations, push notifications, and hourly batch loads into Redshift}
    \resumeItem{Realtime sessionization implemented as a stateful Flink job}
    \resumeItem{Validation against JSONSchema with configurable alerting in Datadog}
    \resumeItemListEnd{}
    ...
    \resumeItem{Standardized Jupyter Notebook infrastructure based on Docker, Papermill, and NBViewer. This let users use notebooks in production workflows, and supported local development in an identical environment to production.}
 ...
 I specialized in recommendation signal and user activity data, working in Spark, SQL, and Python. Projects included:
  \resumeItemListStart{}
  \resumeItem{Algorithms for the weekly newsletter, cart abandonment and price drops notifications, in Spark + SQL. The newsletter algo tripled the the revenue attributed to the weekly newsletter immediately, to about \$700k/week.}
    \resumeItem{Models to determine event and performer popularity in Keras for event recommendations and search.}
    \resumeItem{Ccustomer entity-linking algorithm to deduplicate devices and users in marketing attribution and funnel KPIs.}
  ...
  \resumeItemListStart{}
  \resumeItem{I built features for search, marketing, and frontpage recommendations in Python (Tornado), Elasticsearch, Postgres, Redis, and RabbitMQ.}
  \resumeItemListEnd{}

  
  \resumeQuadHeadingChild{Greater Harlem Coalition, Volunteer}{2022-}
  \resumeItemListStart{}
  \resumeItem{Contributed writing and data analysis to advocate for a just distribution of social services. Code \href{https://github.com/skritch/ghc-analysis}{\uline{here}}.}
  \resumeItemListEnd{}
\resumeHeadingListEnd{}
%---------------------------------------------
